...
export const Content=()=>{
    ...
    return(
        <>
    <Link to='/product'> <img className={styles.image} src="https://images-static.nykaa.com/uploads/97c7b392-4eca-4307-ae47-f0cf06bdf6b7.jpg?tr=w-1200,pr-true" alt='blank'/></Link>   
    <Link to='/product'>  <img className={styles.image2} src="https://images-static.nykaa.com/uploads/65501f8a-2010-4800-8d6f-e52fbc4e3a92.jpg?tr=w-1200,pr-true" alt='blank'/></Link>
        <p className={styles.para1}>IN THE SPOTLIGHT</p>
        <Link to='/product'>  <div className={styles.imageContainer}>
            {
