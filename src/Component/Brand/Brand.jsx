        ...
        isLoading ? <div className={styles.loading}><VscLoading/></div> :   currentproduct.map((item)=>{
                    return(
                        <div key={item.id} className={styles.container}>
                            ...
                            <p className={styles.pricecontainer}>MRP: <BiRupee/>{item.Price} | {item.Discount}% off</p>
                            <p className={styles.namecontainer}><FaStar/><FaStar/><FaStar/><FaStarHalfAlt/><FaStarHalfAlt/> {item.Rating}</p>
